    ...
    handleSave(){
        ...
        .then(result => {
            ...
            if(result.includes("Error")){
                ...
                this.template.querySelector('c-custom-toast-message').showToast('error', result);

            }else if(result.includes("successfully")){
                //this.displayToast('success',result,'Success!!');
                this.template.querySelector('c-custom-toast-message').showToast('success', result);
            }
        ...
        .catch(error => {
            ...
            this.template.querySelector('c-custom-toast-message').showToast('error', error);
